...
4. Do NOT open any subdoc beyond what's listed above. P17 onward will tell you exactly which subdoc to read for each implementation pass.

5. Do NOT write code. Do NOT run the build. Do NOT modify any file. This is read-only orientation.

When you've reported your findings, the session ends. I'll start P17 in a new session.
```
