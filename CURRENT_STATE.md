...
Last updated: **2026-05-11** (off-roadmap **wan-fixes 1–15** shipped between P16 and P17 based on a two-laptop bake test (MN ↔ AZ) and a follow-up local-LAN session — see the "wan-fixes" subsection further down for the full list. Headline deltas:
