...
The project is in **M5 — Maps & content** (in progress; P01–P13 in).
...
weapons / decorations / HUD / shader). Audio + 8 authored maps
land in P14, P17, and P18.
...
```
soldut/
├── src/                 # game source (~39 modules / 76 .c+.h files post-M5 P13)
├── assets/
